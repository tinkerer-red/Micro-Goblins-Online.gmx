    ...
    if (surface_exists(sf_0) && surface_exists(sf_1)) {
        draw_enable_alphablend(false);
            ...
            surface_set_target(sf_0);
                var t_y, t_x, t_y_end = argument3 + argument5 - 1, t_x_end = argument2 + argument4 - 1, a = global.ats_a, rgb = global.ats_rgb, tile,
                    tile_variants_max_minus_one = global.ats_tile_variants_max - 1, grid_tile_variants = global.ats_grid_tile_variants;
