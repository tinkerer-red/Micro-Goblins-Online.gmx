///paintSurfaceOntoScreenAbsolute(surface,x,y,calling_chunk)
var _surf=argument[0];
var _x=argument[1];
var _y=argument[2];
var chunkey=argument[3];
...
collider.sprite_index=spr1pix;
collider.x=_x;
collider.y=_y;
collider.image_xscale=surface_get_width(_surf);
collider.image_yscale=surface_get_height(_surf);
