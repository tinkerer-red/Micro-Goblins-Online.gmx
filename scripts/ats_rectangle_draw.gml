...
with (argument0) {
    ...
    texture_set_interpolation(false);
        shader_set(sh_ats_1);
            texture_set_stage(obj_chunk_supervisor.ats_uniform_sh_ats_1_texture_tiles, obj_chunk_supervisor.ats_texture_tiles);
            shader_set_uniform_f(obj_chunk_supervisor.ats_uniform_sh_ats_1_precalculated_0, width_px, height_px, obj_chunk_supervisor.ats_texture_tiles_texel_width, obj_chunk_supervisor.ats_texture_tiles_texel_height);
            shader_set_uniform_f(obj_chunk_supervisor.ats_uniform_sh_ats_1_precalculated_1, sf_texel_width, sf_texel_height, obj_chunk_supervisor.ats_tile_width, obj_chunk_supervisor.ats_tile_height);
            texture_set_stage(obj_chunk_supervisor.ats_uniform_sh_ats_1_texture_quads, surface_get_texture(sf_1));
                ...
                if (sf_optimization_update) {
                    ...
                    draw_enable_alphablend(false);
                        surface_set_target(sf_optimization);
                            draw_surface_ext(sf_0, 0, 0, obj_chunk_supervisor.ats_tile_width, obj_chunk_supervisor.ats_tile_height, 0, c_white, 1);
                        surface_reset_target();
                    draw_enable_alphablend(true);
                }
            } else {
                draw_set_blend_mode_ext(bm_one, bm_inv_src_alpha);
                    draw_surface_part_ext(sf_0, argument2, argument3, argument4, argument5, argument6, argument7, obj_chunk_supervisor.ats_tile_width, obj_chunk_supervisor.ats_tile_height, c_white, 1);
    ...
    if (surface_optimization_enabled) {
        draw_set_blend_mode_ext(bm_one, bm_inv_src_alpha);
            draw_surface_part(sf_optimization, argument2 * obj_chunk_supervisor.ats_tile_width, argument3 * obj_chunk_supervisor.ats_tile_height, argument4 * obj_chunk_supervisor.ats_tile_width, argument5 * obj_chunk_supervisor.ats_tile_height, argument6, argument7);
        draw_set_blend_mode(bm_normal);
    }
}
