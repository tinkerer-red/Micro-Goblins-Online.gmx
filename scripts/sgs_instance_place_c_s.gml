/// sgs_instance_place_c_s(sgs_field, x, y, obj);
/*
...
The _s (Safe) varient performs the instance_place first 
...
celx1 = median(0,floor((argument1)/cel_size),celxlst);
cely1 = median(0,floor((argument2)/cel_size),celylst);
celx2 = median(0,floor((argument1)/cel_size),celxlst);
cely2 = median(0,floor((argument2)/cel_size),celylst);
