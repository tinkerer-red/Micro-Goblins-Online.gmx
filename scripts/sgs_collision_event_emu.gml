/// sgs_collision_event_emu(sgs_field, collision_script);
/*
...
xx =x;
yy =y;
celx1 = median(0,floor((xx-sprite_xoffset)/cel_size),celxlst);
cely1 = median(0,floor((yy-sprite_yoffset)/cel_size),celylst);
celx2 = median(0,floor((xx-sprite_xoffset+sprite_width)/cel_size),celxlst);
cely2 = median(0,floor((yy-sprite_yoffset+sprite_height)/cel_size),celylst);
